/*
  ...
  - You are about to drop the column `tillageId` on the `Address` table. All the data in the column will be lost.

*/
-- DropIndex
DROP INDEX `Address_tillageId_key` ON `Address`;

-- AlterTable
ALTER TABLE `Address` DROP COLUMN `tillageId`;
