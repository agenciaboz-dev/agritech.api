...
import { User, Tillage, Coordinate, Gallery, Kit, Object, Calendar, Call, Chat } from "@prisma/client"
...
export const handleSocket = (socket: Socket) => {
    ...
    // CALENDAR OPS
    socket.on("employee:calendar:create", (newObject: Calendar) => calendar.newCalendarEmp(socket, newObject))

    socket.on("kit:calendar:create", (newObject: Calendar) => calendar.newCalendarKit(socket, newObject))
