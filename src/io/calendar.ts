...
const newCalendarEmp = async (socket: Socket, data: any) => {
  ...
  try {
    const calendar = await databaseHandler.calendar.createEmp(data);
...
const newCalendarKit = async (socket: Socket, data: any) => {
  ...
  try {
    const calendar = await databaseHandler.calendar.createKit(data);
...
const updateCalendar = async (socket: Socket, data: any) => {
  ...
  try {
    const object = await databaseHandler.calendar.update(data);
...
const listCalendar = async (socket: Socket) => {
  ...
  const calendar = await databaseHandler.calendar.list();
